...
export function UserProfileInfo({ user, posts, profileId, setShowEdit } : UserProfileInfoProps) {
  return (
        ...
        <div className="w-full pt-16 md:pt-0 md:pl-36">
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm text-gray-500 mt-4">
            ...
            <span className="flex items-center gap-1.5">
              ...
              Joined <span className="font-medium">{formatDistanceToNow(user.createdAt)}</span>
            </span>
          </div>
          ...
          <div className="flex items-center gap-6 mt-6 border-t border-gray-200 pt-4">
            <div>
              ...
              <span className="text-xs sm:text-sm font-medium text-gray-500 ml-1.5">
                Posts
              </span>
            </div>
